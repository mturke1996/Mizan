...
export const COMMON_TRANSACTION_TEMPLATES: readonly TransactionTemplate[] =
  Object.freeze([
    ...
    {
      id: "common-expense-marketing",
      label: "تسويق",
      kind: "expense",
      title: "تسويق وإعلانات",
      source: "common",
    },
    {
      id: "common-expense-maintenance",
      label: "صيانة",
      kind: "expense",
      title: "صيانة وتشغيل",
      source: "common",
    ...
    },
    {
      ...
      label: "مستلزمات",
      kind: "expense",
      title: "مستلزمات وأدوات",
      source: "common",
    },
    {
      id: "common-expense-fees",
      label: "رسوم",
      kind: "expense",
      title: "رسوم وضرائب",
      source: "common",
