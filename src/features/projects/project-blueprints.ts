...
> = Object.freeze({
  ...
  auto: defineBlueprint({
    type: "auto",
    name: "ورشة وصيانة سيارات",
    description: "تابع قطع الغيار والصيانة اليومية وأجور الفنيين والعمال.",
    icon: Car,
    defaultModules: {
      transactions: true,
      goal: false,
    ...
    suggestedCategories: [
      { name: "قطع غيار", kind: "expense" },
      { name: "زيوت وفلاتر", kind: "expense" },
      { name: "أجور فنيين", kind: "expense" },
      { name: "معدات وأدوات", kind: "expense" },
      { name: "أتعاب صيانة ميكانيكا", kind: "income" },
      { name: "صيانة كهرباء وتكييف", kind: "income" },
      { name: "فحص وتغيير زيت", kind: "income" },
    ],
    setupSteps: [
      SETUP_STEPS.capital,
      SETUP_STEPS.firstTransaction,
  ...
  salon: defineBlueprint({
    type: "salon",
    name: "صالون وتجميل",
    description: "تابع أدوات التجميل ومبيعات الخدمات ورواتب الطاقم.",
    icon: Scissors,
    defaultModules: {
      transactions: true,
      goal: true,
    ...
    suggestedCategories: [
      { name: "مستحضرات وأدوات", kind: "expense" },
      { name: "إيجار ومرافق", kind: "expense" },
      { name: "أجور ونسب طاقم", kind: "expense" },
      { name: "خدمات تصفيف وعناية", kind: "income" },
      { name: "باقات عرايس وتجميل", kind: "income" },
      { name: "مبيعات منتجات عناية", kind: "income" },
    ],
    setupSteps: [
      SETUP_STEPS.capital,
      SETUP_STEPS.goal,
  ...
  pharmacy: defineBlueprint({
    type: "pharmacy",
    name: "صيدلية ومستلزمات طبية",
    description: "تتبّع مشتريات ومبيعات الأدوية والمستلزمات الطبية.",
    icon: Pill,
    defaultModules: {
      transactions: true,
      goal: true,
    ...
    suggestedCategories: [
      { name: "مشتريات أدوية", kind: "expense" },
      { name: "مستلزمات طبية", kind: "expense" },
      { name: "تجهيزات وتبريد", kind: "expense" },
      { name: "مبيعات أدوية", kind: "income" },
      { name: "مبيعات مستحضرات", kind: "income" },
    ],
    setupSteps: [
      SETUP_STEPS.capital,
      SETUP_STEPS.goal,
  ...
  tech: defineBlueprint({
    type: "tech",
    name: "تقنية واستشارات IT",
    description: "تابع عقود التطوير واشتراكات الخوادم والأجهزة وفريق البرمجة.",
    icon: Laptop,
    defaultModules: {
      transactions: true,
      goal: true,
    ...
    suggestedCategories: [
      { name: "استضافة ودومينات", kind: "expense" },
      { name: "اشتراكات وتراخيص", kind: "expense" },
      { name: "أدوات تطوير ومعدات", kind: "expense" },
      { name: "أجور مبرمجين", kind: "expense" },
      { name: "عقود برمجة وتطوير", kind: "income" },
      { name: "دفعات استشارية", kind: "income" },
      { name: "اشتراكات برمجية (SaaS)", kind: "income" },
    ],
    setupSteps: [
      SETUP_STEPS.goal,
      SETUP_STEPS.firstTransaction,
  ...
  events: defineBlueprint({
    type: "events",
    name: "استوديو وفعاليات",
    description: "تابع حوزات التصوير والمعدات والفعاليات وطاقم التنفيذ.",
    icon: Camera,
    defaultModules: {
      transactions: true,
      goal: true,
    ...
    suggestedCategories: [
      { name: "إيجار معدات وتصوير", kind: "expense" },
      { name: "تجهيزات ديكور وإضاءة", kind: "expense" },
      { name: "رواتب مصورين ومساعدين", kind: "expense" },
      { name: "نقل ولوجستيات", kind: "expense" },
      { name: "حجوزات تصوير مناسبات", kind: "income" },
      { name: "إنتاج ومونتاج فيديو", kind: "income" },
    ],
    setupSteps: [
      SETUP_STEPS.capital,
      SETUP_STEPS.goal,
  ...
  realestate: defineBlueprint({
    type: "realestate",
    name: "عقارات وتطوير",
    description: "تابع مبيعات العقارات والأراضي وتكاليف البناء والعمولات.",
    icon: Building2,
    defaultModules: {
      transactions: true,
      goal: true,
    ...
    suggestedCategories: [
      { name: "شراء أراضي وعقارات", kind: "expense" },
      { name: "تراخيص ورسوم قانونية", kind: "expense" },
      { name: "عمولات سماسرة", kind: "expense" },
      { name: "صيانة وتطوير", kind: "expense" },
      { name: "مبيعات عقارية", kind: "income" },
      { name: "إيجارات مجمعة", kind: "income" },
      { name: "عمولات تسويق", kind: "income" },
    ],
    setupSteps: [
      SETUP_STEPS.capital,
      SETUP_STEPS.goal,
